(() => {
  ...
  const STATIC_UI_TRANSLATIONS = {
    ...
    EN: {
      ...
      "Hesabını kalıcı olarak silmek istiyorsan aşağıdaki butona bas. Bu işlem geri alınamaz.": "If you want to permanently delete your account, press the button below. This action cannot be undone.",
      "Hesap Silme Onayı": "Account Deletion Confirmation",
      "Bu işlem geri alınamaz. Tüm verileriniz (yorumlar, favoriler, hesap bilgileri) kalıcı olarak silinecektir.": "This action cannot be undone. All your data (reviews, favorites, account info) will be permanently deleted.",
      "Onaylamak için e-posta adresinizi yazın:": "Enter your email to confirm:",
      "Vazgeç": "Cancel",
    ...
    RU: {
      ...
      "Hesabını kalıcı olarak silmek istiyorsan aşağıdaki butona bas. Bu işlem geri alınamaz.": "Если вы хотите навсегда удалить свой аккаунт, нажмите кнопку ниже. Это действие необратимо.",
      "Hesap Silme Onayı": "Подтверждение удаления аккаунта",
      "Bu işlem geri alınamaz. Tüm verileriniz (yorumlar, favoriler, hesap bilgileri) kalıcı olarak silinecektir.": "Это действие необратимо. Все ваши данные (отзывы, избранное, данные аккаунта) будут удалены.",
      "Onaylamak için e-posta adresinizi yazın:": "Для подтверждения введите ваш e-mail:",
      "Vazgeç": "Отмена",
    ...
    DE: {
      ...
      "Hesabını kalıcı olarak silmek istiyorsan aşağıdaki butona bas. Bu işlem geri alınamaz.": "Wenn du dein Konto dauerhaft löschen möchtest, drücke den Button unten. Diese Aktion kann nicht rückgängig gemacht werden.",
      "Hesap Silme Onayı": "Kontolöschung bestätigen",
      "Bu işlem geri alınamaz. Tüm verileriniz (yorumlar, favoriler, hesap bilgileri) kalıcı olarak silinecektir.": "Diese Aktion kann nicht rückgängig gemacht werden. Alle Daten (Bewertungen, Favoriten, Kontodaten) werden dauerhaft gelöscht.",
      "Onaylamak için e-posta adresinizi yazın:": "Gib deine E-Mail zur Bestätigung ein:",
      "Vazgeç": "Abbrechen",
      "Kalıcı Olarak Sil": "Dauerhaft löschen",
    },
    ZH: {
      "Anasayfa": "首页",
      "Ayarlar": "设置",
      ...
      "Çıkış yap": "退出",
      "Hesabımı Sil": "删除账户",
      "Hesabını kalıcı olarak silmek istiyorsan aşağıdaki butona bas. Bu işlem geri alınamaz.": "如果您想永久删除您的账户，请按下面的按钮。此操作无法撤消。",
      "Hesap Silme Onayı": "确认删除账户",
      "Bu işlem geri alınamaz. Tüm verileriniz (yorumlar, favoriler, hesap bilgileri) kalıcı olarak silinecektir.": "此操作无法撤消。您的所有数据（评论、收藏、账户信息）将被永久删除。",
      "Onaylamak için e-posta adresinizi yazın:": "请输入您的电子邮件以确认：",
      "Vazgeç": "取消",
