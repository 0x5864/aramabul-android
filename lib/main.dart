    ...
    await _controller.runJavaScript('''
      ...
      if (!document.getElementById('aramabul-app-css')) {
        ...
        style.textContent = 
          ...
          '.istanbul-filter-yeme-icme-sidebar { background: #48769f !important; border-radius: 14px !important; padding: 12px !important; display: flex !important; flex-direction: column !important; gap: 8px !important; width: 100% !important; box-sizing: border-box !important; }' +
          '.istanbul-filter-location-box, .istanbul-filter-section-box { background: transparent !important; border: none !important; box-shadow: none !important; padding: 0 !important; margin: 0 !important; width: 100% !important; box-sizing: border-box !important; overflow: visible !important; position: relative !important; }' +
          ...
          '.istanbul-filter-location-box { z-index: 200 !important; display: flex !important; flex-direction: row !important; gap: 8px !important; align-items: center !important; }' +
          '.istanbul-filter-location-box .istanbul-filter-field { display: block !important; flex: 1 !important; min-width: 0 !important; margin: 0 !important; padding: 0 !important; }' +
