    ...
    await _controller.runJavaScript('''
      ...
      if (!document.getElementById('aramabul-app-css')) {
        ...
        style.textContent = 
          ...
          '.istanbul-filter-location-box { background: #48769f !important; border: none !important; border-radius: 14px !important; padding: 12px !important; margin-bottom: 8px !important; display: grid !important; grid-template-columns: 1fr 1fr !important; gap: 8px !important; width: 100% !important; box-sizing: border-box !important; overflow: visible !important; position: relative !important; z-index: 200 !important; }' +
