      ...
      <div class="venue-popup-content">
        ...
        <div class="venue-popup-header" style="display: flex; flex-direction: column; gap: 0.35rem; padding-right: 3rem;">
          <div style="display: flex; align-items: center; justify-content: space-between; gap: 1.5rem; width: 100%;">
            ...
            <button class="venue-popup-info-chip-btn venue-popup-main-detail-btn" type="button" style="flex-shrink: 0;"><img src="assets/detail.png?v=20260601b" class="venue-popup-chip-icon" alt="" />Ayrıntılı Bilgi</button>
          </div>
          ...
          .then((data) => {
            ...
            items.slice(0, 6).forEach((v) => {
              ...
              card.innerHTML = `
                ...
                <button class="venue-popup-info-chip-btn" type="button"><img src="assets/detail.png?v=20260601b" class="venue-popup-chip-icon" alt="" />Ayrıntılı Bilgi</button>
              `;
